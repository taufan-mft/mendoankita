...
Public Class CrystalReportNota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dianis3.CrystalReportNota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportNota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportNota = New CrystalReportNota()
        rpt.Site = Me.Site
        Return rpt
    End Function
