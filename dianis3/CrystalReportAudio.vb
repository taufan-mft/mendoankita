...
Public Class CrystalReportAudio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dianis3.CrystalReportAudio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportAudio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportAudio = New CrystalReportAudio()
        rpt.Site = Me.Site
        Return rpt
    End Function
