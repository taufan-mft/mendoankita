...
Public Class CrystalReportFilm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dianis3.CrystalReportFilm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportFilm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportFilm = New CrystalReportFilm()
        rpt.Site = Me.Site
        Return rpt
    End Function
