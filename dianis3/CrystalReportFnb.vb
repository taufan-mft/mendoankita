...
Public Class CrystalReportFnb
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dianis3.CrystalReportFnb.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportFnb
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportFnb = New CrystalReportFnb()
        rpt.Site = Me.Site
        Return rpt
    End Function
